...
| `E2E_RUN_ID` | `tests/cloud-storage-flow.spec.ts` | MinIO prefix (`s3://flowfile-test/cloud-e2e-<id>/`) and connection-name suffix; defaults to a timestamp. |
