...
def group_nodes_by_depth(node_info:dict):
...
def define_node_connections(node_info:dict):
...
def build_flow_paths(node_info:dict, flow_starts, merge_points:dict):
...
def draw_merged_paths(node_info:dict, merge_points:dict, paths_by_merge:dict, merge_drawn:set, drawn_nodes:set, lines:str):
...
def draw_standalone_paths(drawn_nodes:set, standalone_paths:list, lines:str, node_info:dict):
...
def add_undrawn_nodes(drawn_nodes:set, node_info:dict, lines:str):
