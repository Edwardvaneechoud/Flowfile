...
def save_flow_to_catalog(
    ...
    # Re-pass through the CodeQL-trusted sanitizer so the taint path from
    # flow_name -> filename -> flow_path hits a recognized py/path-injection
    # sanitizer immediately before any filesystem sink in this function.
    flow_path = validate_path_under_cwd(flow_path)
