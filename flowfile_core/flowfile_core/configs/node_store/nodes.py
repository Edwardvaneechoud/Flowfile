...
def get_all_standard_nodes() -> tuple[list[NodeTemplate], dict[str, NodeTemplate], dict[str, NodeDefault]]:
    ...
    nodes_list: list[NodeTemplate] = [
        ...
        NodeTemplate(
            ...
            drawer_title="Data Science Fit",
            drawer_intro="Fit an estimator and publish it to the Catalog as a versioned artefact",
            laziness="eager",
        ),
        NodeTemplate(
            name="Data Science Predict",
            item="data_science_predict",
            input=1,
            output=1,
            transform_type="narrow",
            node_type="process",
            ...
            node_group="data_science",
            drawer_title="Data Science Predict",
            drawer_intro="Apply a Catalog estimator to incoming data",
            laziness="conditional",
        ),
        NodeTemplate(
