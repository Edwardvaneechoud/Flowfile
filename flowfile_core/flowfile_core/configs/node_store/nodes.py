...
def get_all_standard_nodes() -> tuple[list[NodeTemplate], dict[str, NodeTemplate], dict[str, NodeDefault]]:
    ...
    nodes_list: list[NodeTemplate] = [
        ...
        NodeTemplate(
            ...
            item="linear_regression_fit",
            input=1,
            output=1,
            transform_type="narrow",
            node_type="process",
            image="data_science_fit.svg",
            node_group="data_science",
            drawer_title="Linear Regression Fit",
            drawer_intro="Fit an OLS linear regression and publish the coefficients to the Catalog",
            laziness="eager",
        ),
        NodeTemplate(
            name="Linear Regression Predict",
            item="linear_regression_predict",
            input=1,
            output=1,
            transform_type="narrow",
            node_type="process",
            image="data_science_predict.svg",
            node_group="data_science",
            drawer_title="Linear Regression Predict",
            drawer_intro="Apply a published linear regression artefact to incoming data",
            laziness="conditional",
        ),
        NodeTemplate(
