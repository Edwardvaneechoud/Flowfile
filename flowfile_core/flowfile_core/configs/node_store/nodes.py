...
def get_all_standard_nodes() -> tuple[list[NodeTemplate], dict[str, NodeTemplate], dict[str, NodeDefault]]:
    ...
    nodes_list: list[NodeTemplate] = [
        ...
        NodeTemplate(
            ...
            transform_type="other",
            node_type="input",
            image="list_files.svg",
            node_group="input",
            drawer_title="List Files",
            drawer_intro="List a folder's contents as a table",
            laziness="lazy",
            tags=[
                NodeTag.LIST_FILES,
                NodeTag.FOLDER,
        ...
        NodeTemplate(
            ...
            item="multi_field_formula",
            input=1,
            output=1,
            transform_type="narrow",
            node_type="process",
            image="multi_field_formula.svg",
            node_group="transform",
            drawer_title="Multi-Field Formula",
            drawer_intro="Apply one expression to many columns at once",
            laziness="lazy",
            tags=[NodeTag.FORMULA, NodeTag.EXPRESSION, NodeTag.COLUMNS, NodeTag.TRANSFORM, NodeTag.CALCULATE],
        ),
        NodeTemplate(
            name="Write data",
            item="output",
        ...
        NodeTemplate(
            ...
            input=2,
            output=1,
            input_labels=["Left (passes through)", "Right (waits for completion)"],
            transform_type="other",
            node_type="process",
            image="wait_for.svg",
            node_group="combine",
        ...
        NodeTemplate(
            ...
            transform_type="other",
            node_type="input",
            image="flow_input.svg",
            node_group="input",
            drawer_title="Flow Input",
            drawer_intro="Named entry point for data when this flow runs inside another flow",
            laziness="lazy",
            tags=[NodeTag.INPUT, NodeTag.MANUAL],
        ),
        NodeTemplate(
            name="Flow Output",
            item="flow_output",
            ...
            transform_type="other",
            node_type="output",
            image="flow_output.svg",
            node_group="output",
            drawer_title="Flow Output",
            drawer_intro="Named exit point exposing this dataset when the flow runs inside another flow",
            laziness="eager",
            tags=[NodeTag.EXPORT, NodeTag.RESPONSE],
        ),
        NodeTemplate(
            name="Run Flow",
            item="run_flow",
            ...
            drawer_intro="Execute a flow from the catalog, mapping data and parameters into it",
            laziness="eager",
            tags=[NodeTag.DEPENDENCY, NodeTag.CATALOG],
        ),
    ]
