...
from flowfile_core.routes.unity_catalog import router as unity_catalog_router
...
app.include_router(unity_catalog_router, prefix="/unity_catalog", tags=["unity_catalog"])
