...
from flowfile_core.routes.admin_settings import router as admin_settings_router
...
app.include_router(admin_settings_router, prefix="/admin", tags=["admin_settings"])
