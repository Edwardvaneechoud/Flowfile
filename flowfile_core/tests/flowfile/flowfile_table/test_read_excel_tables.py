...
def test_read_excel_table_basic():
    excel_table = ReceivedTable(path='flowfile_core/tests/support_files/data/excel_file.xlsx', name='excel_file',
                                file_type='excel',
                                sheet_name='Sheet1')
    try:
...
def test_read_excel_table_external():
    excel_table = ReceivedTable(path='flowfile_core/tests/support_files/data/excel_file.xlsx', name='excel_file',
                                ...
                                sheet_name='Sheet1')
    try:
        flowfile_table = FlowfileTable.create_from_path_worker(excel_table, flow_id=-1, node_id=-1)
...
def test_read_excel_table_with_type_interference():
    excel_table = ReceivedTable(path='flowfile_core/tests/support_files/data/excel_file.xlsx',
...
def test_read_excel_starting_from_line10():
    received_table = ReceivedTable(path='flowfile_core/tests/support_files/data/excel_file.xlsx',
                                   name='excel_file', file_type='excel',
