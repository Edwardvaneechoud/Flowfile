...
#     result_df = get_result_from_generated_code(code)
#     expected_df = flow.get_node(1).get_resulting_data().collect()
#     assert_frame_equal(expected_df.collect(), result_df, check_row_order=False)
#
#
...
#     """Test record ID generation with and without grouping"""
#     flow = create_basic_flow()
#
#     # Add manual input
#     data = input_schema.NodeManualInput(
...
#     code = export_flow_to_polars(flow)
#
#     # Verify record ID code
#     verify_code_contains(code,
#                          "cumcount().over(['category']) + 1",
#                          ".alias('row_num')"
#                          )
#
#
...
#
#     # Verify sample code
#     verify_code_contains(code, "sample(n=3)")
#
#
# def test_empty_flow():
...
#
#
# def test_basic_filter_types():
#     """Test different basic filter types"""
#     flow = create_basic_flow()
#     flow = create_sample_dataframe_node(flow)
#
#     # Test basic filter with equals
#     filter_node = input_schema.NodeFilter(
#         flow_id=1,
#         node_id=2,
#         depending_on_id=1,
...
#     code = export_flow_to_polars(flow)
#
#     # Verify basic filter code
#     verify_code_contains(code, 'pl.col("city") == "NYC"')
#
#
...
#
#     # Test Excel output
#     flow2 = create_basic_flow()
#     flow2 = create_sample_dataframe_node(flow2)
#
...
#         )
#     )
#     flow2.add_output(excel_output)
#
#     code2 = export_flow_to_polars(flow2)
#     verify_code_contains(code2,
#                          "write_excel(",
#                          'worksheet="Results"'
#                          )
#
...
#     code = export_flow_to_polars(flow)
#
#     # Should have a comment about skipping
#     verify_code_contains(code, "# Skipping uninitialized node: 1")
#
#
# def test_filter_expression_parsing():
#     """Test various filter expression formats"""
#     flow = create_basic_flow()
#     flow = create_sample_dataframe_node(flow)
#
#     # Test different filter expressions
#     test_cases = [
#         ('[age]>=30', 'pl.col("age") >= 30'),
#         ('[name]="Alice"', 'pl.col("name") == "Alice"'),
#         ('[salary]<60000', 'pl.col("salary") < 60000'),
#         ('[city]!="NYC"', 'pl.col("city") != "NYC"'),
#     ]
#
#     for i, (filter_expr, expected_output) in enumerate(test_cases, start=2):
#         filter_node = input_schema.NodeFilter(
#             flow_id=1,
#             node_id=i,
#             depending_on_id=1,
...
#     code = export_flow_to_polars(flow)
#
#     # Verify all filter expressions are correctly parsed
#     for _, expected in test_cases:
#         verify_code_contains(code, expected)
#
#
...
#
#
# def test_record_id_without_grouping():
#     """Test simple record ID generation without grouping"""
#     flow = create_basic_flow()
#     flow = create_sample_dataframe_node(flow)
#
#     # Add record ID without grouping
#     record_id_node = input_schema.NodeRecordId(
#         flow_id=1,
#         node_id=2,
#         depending_on_id=1,
...
#     code = export_flow_to_polars(flow)
#
#     # Verify simple row count
#     verify_code_contains(code,
#                          "with_row_count(name='row_id', offset=0)"
#                          )
#
#
...
#         flow_id=1,
#         node_id=1,
#         received_file=input_schema.ReceivedParquetTable(
#             name="data.parquet",
...
#         flow_id=1,
#         node_id=1,
#         received_file=input_schema.ReceivedExcelTable(
#             name="data.xlsx",
...
#     """Test handling of select nodes with unavailable columns"""
#     flow = create_basic_flow()
#     flow = create_sample_dataframe_node(flow)
#
#     # Add select with some invalid columns
#     select_node = input_schema.NodeSelect(
#         flow_id=1,
#         node_id=2,
#         depending_on_id=1,
#         select_input=[
#             transform_schema.SelectInput("name", "name", keep=True, is_available=True),
#             transform_schema.SelectInput("invalid_col", "invalid", keep=True, is_available=False),
#             transform_schema.SelectInput("age", "age", keep=True, is_available=True),
#         ]
#     )
#     flow.add_select(select_node)
#
...
#     code = export_flow_to_polars(flow)
#
#     # Only available columns should be in the select
#     verify_code_contains(code, 'pl.col("name")', 'pl.col("age")')
#     assert 'pl.col("invalid_col")' not in code
#
#
...
# result = sorted.select(['name', 'salary'])"""
#         )
#     )
#     flow.add_polars_code(polars_code_node)
#
