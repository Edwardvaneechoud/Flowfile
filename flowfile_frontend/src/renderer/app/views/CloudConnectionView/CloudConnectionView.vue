  ...
  <div class="cloud-connection-manager-container">
    <div class="mb-3">
      ...
      <p class="description-text">
        Cloud storage connections allow you to connect to your cloud storage services like AWS S3
        and Azure Data Lake Storage. Create and manage your connections here to use them in your
        data workflows.
      </p>
    </div>
      ...
      <div class="card-content">
        ...
        <div class="info-box mb-3">
          ...
          <div>
            ...
            <p>
              Cloud storage connections store the credentials and configuration needed to securely
              access your cloud storage services. Once set up, you can reuse these connections
              throughout your workflows without re-entering credentials.
            </p>
          </div>
        </div>
        ...
        <div v-else class="flex-col gap-2">
          ...
          >
            <div class="secret-info">
              <div class="secret-name">
                ...
                <span class="badge auth-badge">{{
                  getAuthMethodLabel(connection.authMethod)
                }}</span>
              </div>
            ...
            <div class="secret-actions">
              ...
              <button
                v-if="connection.connectionName"
                type="button"
    ...
    >
      <div class="modal-description mb-3">
        <p>
          Configure your cloud storage connection details. Choose your storage provider and
          authentication method, then provide the required credentials.
        </p>
      </div>
