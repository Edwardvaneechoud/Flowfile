"""Enum companions and ``Literal`` types for the string choices of the native node classes.
...
class GateOperator(str, Enum):
    """Operators of a parameter-mode gate condition."""
...
def _literal(value: Any) -> Any:
    """The plain value of an enum member; any other value unchanged."""
