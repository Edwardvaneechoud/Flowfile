...
class FlowFrame:
    ...
    def cast(self, dtypes: Mapping[ColumnNameOrSelector | PolarsDataType, PolarsDataType | PythonDataType] | PolarsDataType | pl.DataTypeExpr, strict: bool=True, description: Optional[str] = None) -> LazyFrame: ...
    ...
    def collect_async(self, gevent: bool=False, engine: EngineType='auto', optimizations: QueryOptFlags=<polars.lazyframe.opt_flags.QueryOptFlags object at 0x1041d45d0>) -> Awaitable[DataFrame] | _GeventDataFrameResult[DataFrame]: ...
    ...
    # Profile a LazyFrame.
    def profile(self, type_coercion: bool=True, predicate_pushdown: bool=True, projection_pushdown: bool=True, simplify_expression: bool=True, no_optimization: bool=False, slice_pushdown: bool=True, comm_subplan_elim: bool=True, comm_subexpr_elim: bool=True, cluster_with_columns: bool=True, collapse_joins: bool=True, show_plot: bool=False, truncate_nodes: int=0, figsize: tuple[int, int]=(18, 8), engine: EngineType='auto', optimizations: QueryOptFlags=<polars.lazyframe.opt_flags.QueryOptFlags object at 0x1041d45d0>, **_kwargs) -> tuple[DataFrame, DataFrame]: ...

    # Aggregate the columns in the LazyFrame to their quantile value.
    def quantile(self, quantile: float | Expr, interpolation: QuantileMethod='nearest', description: Optional[str] = None) -> LazyFrame: ...
    ...
    # Rename column names.
    def rename(self, mapping: Mapping[str, str] | Callable[[str], str], strict: bool=True, description: Optional[str] = None) -> LazyFrame: ...
    ...
    def update(self, other: LazyFrame, on: str | Sequence[str] | None=None, how: Literal['left', 'inner', 'full']='left', left_on: str | Sequence[str] | None=None, right_on: str | Sequence[str] | None=None, include_nulls: bool=False, maintain_order: MaintainOrderJoin | None='left', description: Optional[str] = None) -> LazyFrame: ...
    ...
    def write_delta(self, path: str, connection_name: typing.Optional[str]=None, write_mode: typing.Literal['overwrite', 'append']='overwrite', description: Optional[str] = None) -> 'FlowFrame': ...

    # Write the data frame to cloud storage in JSON format.
    def write_json_to_cloud_storage(self, path: str, connection_name: typing.Optional[str]=None, description: Optional[str] = None) -> 'FlowFrame': ...
    ...
    def write_parquet_to_cloud_storage(self, path: str, connection_name: typing.Optional[str]=None, compression: typing.Literal['snappy', 'gzip', 'brotli', 'lz4', 'zstd']='snappy', description: Optional[str] = None) -> 'FlowFrame': ...
