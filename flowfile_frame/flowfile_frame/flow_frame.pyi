...
class FlowFrame:
    ...
    def apply_model(self, upstream: FlowFrame | None = None, model_name: str = '', output_column: str = 'prediction', version: int | None = None, namespace_id: int | None = None, description: str | None = None) -> 'FlowFrame': ...
    ...
    def filter_split(self, *predicates, flowfile_formula: str | None = None, description: str | None = None, **constraints) -> 'FlowFrame': ...
    ...
    def train_model(self, target: str, features: list[str] | None = None, model_type: str = 'linear_regression', params: dict | None = None, publish_to_catalog: bool = False, model_name: str = '', namespace_id: int | None = None, catalog_description: str | None = None, catalog_tags: list[str] | None = None, description: str | None = None) -> 'FlowFrame': ...
    ...
    def write_catalog_table(self, table_name: str, namespace_id: int | None = None, write_mode: Literal['overwrite', 'error', 'append', 'upsert', 'update', 'delete'] = 'overwrite', merge_keys: list[str] | None = None, description: str | None = None) -> 'FlowFrame': ...
