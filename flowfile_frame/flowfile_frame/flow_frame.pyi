...
class FlowFrame:
    ...
    def write_catalog_table(self, table_name: str, schema: SchemaReference | None = None, namespace_id: int | None = None, write_mode: Literal['overwrite', 'error', 'append', 'upsert', 'update', 'delete'] = 'overwrite', merge_keys: list[str] | None = None, description: str | None = None) -> 'FlowFrame': ...
