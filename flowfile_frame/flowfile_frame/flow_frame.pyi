...
class FlowFrame:
    ...
    def _add_polars_code(self, new_node_id: int, code: str, description: str=None, depending_on_ids: Union[List, NoneType]=None) -> Any: ...
    ...
    def _detect_cum_count_record_id(self, expr: typing.Any, new_node_id: int, description: Union[str, NoneType]=None) -> 'FlowFrame': ...

    # Generate Polars code for sort operations that need fallback.
    def _generate_sort_polars_code(self, sort_expressions: list, descending_values: list, nulls_last_values: list, multithreaded: bool, maintain_order: bool) -> str: ...
    ...
    def filter(self, *predicates, flowfile_formula: str=None, description: str=None, **constraints) -> 'FlowFrame': ...
    ...
    def select(self, *columns, description: str=None) -> 'FlowFrame': ...
    ...
    def sort(self, by: Union[List, Expr, str], *more_by, descending: Union[bool, List]=False, nulls_last: bool=False, multithreaded: bool=True, maintain_order: bool=False, description: str=None) -> 'FlowFrame': ...
