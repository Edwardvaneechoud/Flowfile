...
class FlowFrame:
    ...
    def _try_translate_formulas_to_polars(self, flowfile_formulas: list[str], output_column_names: list[str], datatypes: list[str], description: str | None) -> FlowFrame | None: ...
    ...
    def save_to_catalog(self, name: str, schema: SchemaReference | None = None, description: str | None = None) -> 'FlowFrame': ...
    ...
    def with_output_validation(self, fields: list[input_schema.OutputFieldInfo | dict], validation_mode_behavior: Literal['add_missing', 'add_missing_keep_extra', 'raise_on_missing', 'select_only'] = 'select_only', validate_data_types: bool = True, description: Optional[str] = None) -> 'FlowFrame': ...
    ...
    def write_catalog_table(self, table_name: str, schema: SchemaReference | None = None, namespace_id: int | None = None, write_mode: Literal['overwrite', 'error', 'append', 'upsert', 'update', 'delete', 'virtual'] = 'overwrite', merge_keys: list[str] | None = None, description: str | None = None) -> 'FlowFrame': ...
    ...
    def write_delta(self, path: str, connection_name: str | None = None, write_mode: Literal['overwrite', 'append'] = 'overwrite', description: str | None = None) -> 'FlowFrame': ...
