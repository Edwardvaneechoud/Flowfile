...
class RunFlow(NativeNode):
    flow: FlowRef
    def __init__(self, flow: FlowRef | int | FlowGraph | FlowFrame, *, name: str | None=None, schema: SchemaReference | None=None, overwrite: bool=False, inputs: Mapping[str, FlowFrame] | None=None, params: Mapping[str | Parameter, Any] | None=None, param_frame: FlowFrame | None=None, iterate: bool=False, append_metadata: bool=True, description: str | None=None, flow_graph: FlowGraph | None=None, **input_frames: FlowFrame) -> None: ...
