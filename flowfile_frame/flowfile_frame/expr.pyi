...
class StringMethods:
    ...
    def strip_chars_end(self, characters: str | None=None) -> Any: ...

    def strip_chars_start(self, characters: str | None=None) -> Any: ...
...
class ExprListNameSpace:
    ...
    def _create_next_expr(self, *args, method_name: str, result_expr: pl.Expr | None, is_complex: bool=True, **kwargs) -> Expr: ...
...
class Expr:
    ...
    def __init__(self, expr: pl.Expr | None, column_name: str | None=None, repr_str: str | None=None, initial_column_name: str | None=None, selector: Selector | None=None, agg_func: str | None=None, ddof: int | None=None, is_complex: bool=False, convertable_to_code: bool=True, _function_sources: list[str] | None=None, ff_repr: str | None=None) -> Any: ...
    ...
    def _create_binary_op_expr(self, op_symbol: str, other: Any, result_expr: pl.Expr | None, ff_repr: str | None=Ellipsis) -> Expr: ...

    # Creates a new Expr instance, appending method call to repr string.
    def _create_next_expr(self, *args, method_name: str, result_expr: pl.Expr | None, convertable_to_code: bool=None, is_complex: bool, _function_sources: list[str] | None=None, _repr_override: str | None=None, ff_repr: str | None=None, **kwargs) -> Expr: ...
    ...
    def cut(self, breaks: Sequence[float], labels: Sequence[str_] | None=None, left_closed: bool=False, include_breaks: bool=False) -> Expr: ...

    # Convert from radians to degrees.
    def degrees(self, ) -> Expr: ...

    # Read a serialized expression from a file.
    def deserialize(self, source: str_ | Path | IOBase | bytes, format: SerializationFormat='binary') -> Expr: ...
    ...
    def dist(self, expr: Expr) -> Any: ...

    def dist_arr(self, expr: Expr) -> Any: ...

    def dist_list(self, expr: Expr) -> Any: ...

    def dist_str(self, expr: Expr) -> Any: ...
    ...
    def ewm_mean_by(self, by: str_ | IntoExpr, half_life: str_ | timedelta) -> Expr: ...
    ...
    def exclude(self, columns: str_ | PolarsDataType | Collection[str_ | PolarsDataType], *more_columns) -> Expr: ...
    ...
    def from_json(self, value: str_) -> Expr: ...

    # Take values by index.
    def gather(self, indices: int | Sequence[int] | IntoExpr | Series | np.ndarray[Any, Any], null_on_oob: bool=False) -> Expr: ...
    ...
    def is_close(self, other: IntoExpr, abs_tol: float=0.0, rel_tol: float=1e-09, nans_equal: bool=False) -> Expr: ...
    ...
    def is_sorted(self, descending: bool | None=False, nulls_last: bool | None=False) -> Expr: ...
    ...
    def log(self, base: float | IntoExpr=2.718281828459045) -> Expr: ...
    ...
    def map_elements(self, function: Callable[[Any], Any], return_dtype: PolarsDataType | pl.DataTypeExpr | None=None, skip_nulls: bool=True, pass_name: bool=False, strategy: MapElementsStrategy='thread_local', returns_scalar: bool=False) -> Expr: ...
    ...
    def qcut(self, quantiles: Sequence[float] | int, labels: Sequence[str_] | None=None, left_closed: bool=False, allow_duplicates: bool=False, include_breaks: bool=False) -> Expr: ...

    # Get quantile value.
    def quantile(self, quantile: float | list_[float] | Expr, interpolation: QuantileMethod='nearest') -> Expr: ...
    ...
    def register_plugin(self, lib: str_, symbol: str_, args: list_[IntoExpr] | None=None, kwargs: dict[Any, Any] | None=None, is_elementwise: bool=False, input_wildcard_expansion: bool=False, returns_scalar: bool=False, cast_to_supertypes: bool=False, pass_name_to_apply: bool=False, changes_length: bool=False) -> Expr: ...

    # Reinterpret the underlying bits as a signed/unsigned integer or float.
    def reinterpret(self, signed: bool | None=None, dtype: PolarsDataType | None=None) -> Expr: ...
    ...
    def rolling(self, index_column: IntoExprColumn, period: str_ | timedelta, offset: str_ | timedelta | None=None, closed: ClosedInterval='right') -> Expr: ...
    ...
    def rolling_map(self, function: Callable[[Series], Any], window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Apply a rolling max (moving max) over the values in this array.
    def rolling_max(self, window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Apply a rolling max based on another column.
    def rolling_max_by(self, by: IntoExpr, window_size: timedelta | str_, min_samples: int=1, closed: ClosedInterval='right') -> Expr: ...

    # Apply a rolling mean (moving mean) over the values in this array.
    def rolling_mean(self, window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Apply a rolling mean based on another column.
    def rolling_mean_by(self, by: IntoExpr, window_size: timedelta | str_, min_samples: int=1, closed: ClosedInterval='right') -> Expr: ...

    # Compute a rolling median.
    def rolling_median(self, window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Compute a rolling median based on another column.
    def rolling_median_by(self, by: IntoExpr, window_size: timedelta | str_, min_samples: int=1, closed: ClosedInterval='right') -> Expr: ...

    # Apply a rolling min (moving min) over the values in this array.
    def rolling_min(self, window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Apply a rolling min based on another column.
    def rolling_min_by(self, by: IntoExpr, window_size: timedelta | str_, min_samples: int=1, closed: ClosedInterval='right') -> Expr: ...

    # Compute a rolling quantile.
    def rolling_quantile(self, quantile: float, interpolation: QuantileMethod='nearest', window_size: int=2, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Compute a rolling quantile based on another column.
    def rolling_quantile_by(self, by: IntoExpr, window_size: timedelta | str_, quantile: float, interpolation: QuantileMethod='nearest', min_samples: int=1, closed: ClosedInterval='right') -> Expr: ...

    # Compute a rolling rank.
    def rolling_rank(self, window_size: int, method: RankMethod='average', seed: int | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Compute a rolling rank based on another column.
    def rolling_rank_by(self, by: IntoExpr, window_size: timedelta | str_, method: RankMethod='average', seed: int | None=None, min_samples: int=1, closed: ClosedInterval='right') -> Expr: ...

    # Compute a rolling skew.
    def rolling_skew(self, window_size: int, bias: bool=True, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Compute a rolling standard deviation.
    def rolling_std(self, window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False, ddof: int=1) -> Expr: ...

    # Compute a rolling standard deviation based on another column.
    def rolling_std_by(self, by: IntoExpr, window_size: timedelta | str_, min_samples: int=1, closed: ClosedInterval='right', ddof: int=1) -> Expr: ...

    # Apply a rolling sum (moving sum) over the values in this array.
    def rolling_sum(self, window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False) -> Expr: ...

    # Apply a rolling sum based on another column.
    def rolling_sum_by(self, by: IntoExpr, window_size: timedelta | str_, min_samples: int=0, closed: ClosedInterval='right') -> Expr: ...

    # Compute a rolling variance.
    def rolling_var(self, window_size: int, weights: list_[float] | None=None, min_samples: int | None=None, center: bool=False, ddof: int=1) -> Expr: ...

    # Compute a rolling variance based on another column.
    def rolling_var_by(self, by: IntoExpr, window_size: timedelta | str_, min_samples: int=1, closed: ClosedInterval='right', ddof: int=1) -> Expr: ...
    ...
    def __hash__(self, *args, **kwargs) -> 'Expr': ...
    ...
    def _row_decode(self, *args, **kwargs) -> 'Expr': ...

    def _row_encode(self, *args, **kwargs) -> 'Expr': ...
...
class When(Expr):
    ...
    def _get_branch_ff_repr(self, value) -> str | None: ...
