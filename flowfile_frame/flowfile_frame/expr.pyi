...
class Expr:
    ...
    def __init__(self, expr: Optional[pl.Expr], column_name: Optional[str]=None, repr_str: Optional[str]=None, initial_column_name: Optional[str]=None, selector: Optional['Selector']=None, agg_func: Optional[str]=None, ddof: Optional[int]=None, is_complex: bool=False, convertable_to_code: bool=True) -> Any: ...
    ...
    def map_batches(self, function: callable, return_dtype=None, agg_list: bool=False, is_elementwise: bool=False, returns_scalar: bool=False) -> 'Expr': ...
