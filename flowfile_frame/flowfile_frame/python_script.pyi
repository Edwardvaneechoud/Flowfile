...
def python_script(fn: Callable[..., Any] | None=None, /, *, kernel: str | Any | None=None, outputs: list[str] | None=None, returns: Mapping[str, PolarsDataType] | Mapping[str, Mapping[str, PolarsDataType]] | None=None, description: str | None=None, flow_graph: FlowGraph | None=None) -> PythonScriptFunction | Callable[[Callable[..., Any]], PythonScriptFunction]: ...
