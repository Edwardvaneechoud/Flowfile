...
def read_from_cloud_storage(source: str, *, file_format: Literal['csv', 'parquet', 'json', 'delta']='parquet', connection_name: str | None=None, scan_mode: Literal['single_file', 'directory'] | None=None, delimiter: str=';', has_header: bool=True, encoding: str='utf8', delta_version: int | None=None, output_field_config: OutputFieldConfig | dict | None=None) -> FlowFrame: ...
