...
Usage:
    ...
    # Use type groups
    ColumnSelector(data_types=nd.Types.Numeric)
    ColumnSelector(data_types=nd.Types.String)

    # Use specific types
    ColumnSelector(data_types=nd.Types.Int64)
    ColumnSelector(data_types=nd.Types.Float)

    # Mix and match
    ColumnSelector(data_types=[nd.Types.Numeric, nd.Types.String])
"""
