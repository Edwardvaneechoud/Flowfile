// Palette-drop auto-connect geometry (mirror of the desktop frontend's test).
...
describe('findAutoConnectMatch', () => {
  ...
  it('connects a source dropped left of a node into its first free input', () => {
    const join: AutoConnectNode = { ...reader, id: '2', x: 300, freeInputs: ['input-1'] }
  ...
  it('uses the dragged node\'s own size when given', () => {
    ...
    const drop = { x: 100, y: 100, width: 200, height: 60, inputHandle: null, outputHandle: 'output-0' }
