/**
 * Pure-geometry tests for the canvas overlay panels (ported from the desktop
 * frontend's layoutGeometry.test.ts): intent × container → rect derivation,
 * gesture-stop intent capture, clamping, and magnetic dock snapping.
 */
...
// Shaped like the designer's panels; the non-zero v offset exercises the
// offset math the real configs default to 0.
