...
<template>
  <div class="gw-wrapper">
    <div v-if="isLoading" class="gw-loading">Loading visualization...</div>
    <div v-else-if="loadError" class="gw-error">{{ loadError }}</div>
    <div v-show="!isLoading && !loadError" ref="container" class="gw-react-root"></div>
  </div>
</template>
