...
| `e2e-tests.yml` | Push/PR to `main` (`flowfile_frontend/**`, `flowfile_core/**`, `flowfile_worker/**`, `shared/**`, `test_utils/s3/**`) | Build frontend, start and seed MinIO, start backend, run Playwright web E2E incl. `cloud-storage-flow.spec.ts` |
